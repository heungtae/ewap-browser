...
| Configuration | Partially Implemented | Provider/Profile Resolver settings use storage.local. Managed reads for enterprise_policy/identity/runtime_evidence exist, but the manifest has no managed_schema declaration; managed deployment is incomplete |
