...
export const COMPANY_TOOLS = Object.freeze({
  ...
  set_field: { ...FORM, modes: [CompanyMode.ACT], enabled: false },
  set_checked: { ...FORM, modes: [CompanyMode.ACT], enabled: false },
  type_ax: { ...FORM, modes: [CompanyMode.ACT], enabled: false },
  click_ax: { ...FORM, modes: [CompanyMode.ACT], enabled: false },
  press_keys: { ...FORM, modes: [CompanyMode.ACT], enabled: false },
  scroll: { ...FORM, modes: [CompanyMode.ACT], enabled: false },
  hover: { ...FORM, modes: [CompanyMode.ACT], enabled: false },
  wait_for_element: { ...READ, modes: [CompanyMode.ACT], enabled: false },
  verify_form: { ...READ, modes: [CompanyMode.ACT], enabled: false },
  get_select_options: { ...READ, modes: [CompanyMode.ACT], enabled: false },
  select_option: { ...FORM, modes: [CompanyMode.ACT], enabled: false },
});
